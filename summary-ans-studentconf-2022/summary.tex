...
Such an strategy requires the addition of energy storage mechanisms into the grid.
...
One of the main takeaways from Scenario 1 is that decreasing the electricity purchases has a strong impact on the CO$_2$ emissions.
...
With respect to Scenario 2, larger reactor capacities reduce further the CO$_2$ emissions.
Additionally, the presence of a gen-IV reactor, with higher outlet temperatures and, hence, higher efficiencies, increases the electrical capacity and reduces even further the CO$_2$ emissions.
